#!/bin/bash
#
# This script is run prior to deployment of component Component3dReconstruction
...
source $REFERENCED_PROJECT_Component3dReconstruction/smartsoft/src/predeploy.sh

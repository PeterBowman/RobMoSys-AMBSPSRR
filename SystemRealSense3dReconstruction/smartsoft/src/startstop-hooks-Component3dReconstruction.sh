#!/bin/bash
#
# Start-Stop-Hooks for component Component3dReconstruction
#
...
pre-start)
	...
	bash startstop-hooks-component-Component3dReconstruction.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-Component3dReconstruction.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-Component3dReconstruction.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-Component3dReconstruction.sh post-stop
